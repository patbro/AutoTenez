...
class AutoTenez:
    ...
    def find_time_slot(self, available_slots, first_hour, second_hour=None, courts=[]):
    ...
    def check_court(self, courts, court_name):
    ...
    def make_reservation(self, headers, cookies, date_tomorrow, md5slotkey, your_external_reference, other_players_external_references):
...
if __name__ == "__main__":
    try:
        ...
        # Catch JSONDecodeError
            ...
            print("Plain text content: " + str(r.text))
